...
import { idlFactory } from './ic-secrets-backend.did.js';
export { idlFactory } from './ic-secrets-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IC_SECRETS_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic-secrets-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic-secrets-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic-secrets-backend.did.js")._SERVICE>}
 */
export const ic_secrets_backend = createActor(canisterId);
