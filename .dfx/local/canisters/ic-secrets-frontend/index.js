...
import { idlFactory } from './ic-secrets-frontend.did.js';
export { idlFactory } from './ic-secrets-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_IC_SECRETS_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic-secrets-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic-secrets-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic-secrets-frontend.did.js")._SERVICE>}
 */
export const ic_secrets_frontend = createActor(canisterId);
